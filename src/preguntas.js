...
let preguntas= {
     total:function(arrays){return arrays.length},
     listado: function(arrays){
          preguntitas='\n';
          for(datos in arrays){
               preguntitas += `${arrays[datos].faq_title}\n${arrays[datos].faq_answer}\n\n`
          }
          return preguntitas;
     }
}

//console.log(preguntas.listado(faqs));
